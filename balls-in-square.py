...
random_colors = np.array(list(colors))
random.shuffle(random_colors)
random_colors = random_colors[:4]
print(random_colors[:2], random_colors[2:4], sep='\n')
    ...
    if not is_played:
        ...
        for color in colors:
            ...
            if len(balls_coords) == len(random_colors):
                ...
                left_top_color = random_colors[0]
                right_bottom_color = random_colors[-1]
                if ((balls_coords[random_colors[0]][1] < balls_coords[random_colors[1]][1]
                and balls_coords[random_colors[0]][0] < balls_coords[random_colors[2]][0])
                and (balls_coords[random_colors[-1]][1] > balls_coords[random_colors[2]][1]
                and balls_coords[random_colors[-1]][0] > balls_coords[random_colors[1]][0])):
